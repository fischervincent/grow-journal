    ...
    <div className="w-full max-w-xl m-auto rounded-xl border-[1px] shadow-lg p-6">
      ...
      <div className="flex justify-center mt-4">
        <button
          className={`text-white px-4 py-2 rounded ${
            push.isSubscribed ? "bg-red-500" : "bg-blue-500"
          }`}
          onClick={
            push.isSubscribed ? push.unsubscribeFromPush : push.subscribeToPush
          }
        >
      ...
      {push.isSubscribed ? (
        <>
          ...
          />
          <button
            className="text-white px-4 py-2 rounded bg-indigo-500 mt-4"
            onClick={handleSend}
          >
            Send Message
          </button>
